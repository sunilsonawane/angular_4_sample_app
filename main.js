...
module.exports = "<h3>Some Heroes / Heroines</h3>\n<div class=\"grid grid-pad\">\n  <a *ngFor=\"let hero of heroes\" class=\"col-3-3\" routerLink=\"/detail/{{hero.id}}\">\n    <div class=\"module hero\">\n      <h4>{{hero.name}}</h4>\n    </div>\n  </a>\n</div>"
...
module.exports = "<div *ngIf=\"hero\">\n\t<h2>{{hero.name | uppercase}}'s Details</h2>\n\t<div><span>Id: </span>{{hero.id}}</div>\n\t<div>\n\t  <label>Name:\n\t    <input [(ngModel)]=\"hero.name\" placeholder=\"name\">\n\t  </label>\n\t</div>\n\t<div>\n\t  <label>Gender:{{hero.gender}} </label>\n\t</div>\n</div>\n<br/>\n<button (click)=\"goBack()\">go back</button>"
...
module.exports = "/* HeroesComponent's private CSS styles */\n.selected {\n  background-color: #55D8DC !important;\n  color: white;\n}\n.heroes {\n  margin: 0 0 2em 0;\n  list-style-type: none;\n  padding: 0;\n  width: 15em;\n}\n.heroes li {\n  cursor: pointer;\n  position: relative;\n  left: 0;\n  background-color: #EEE;\n  margin: .5em;\n  padding: .3em 0;\n  height: 1.6em;\n  border-radius: 4px;\n  text-align: left;\n}\n.heroes li.selected:hover {\n  background-color: #CBD844 !important;\n  color: white;\n}\n.heroes li:hover {\n  color: #FF7D8B;\n  background-color: #DDD;\n  left: .1em;\n}\n.heroes .text {\n  position: relative;\n  top: -3px;\n}\n.heroes .badge {\n  display: inline-block;\n  font-size: small;\n  color: white;\n  padding: 0.8em 0.7em 0 0.7em;\n  background-color: #607D8B;\n  line-height: 1em;\n  position: relative;\n  left: -1px;\n  top: -4px;\n  height: 1.8em;\n  margin-right: .8em;\n  border-radius: 4px 0 0 4px;\n}"
...
var HEROES = [
    { id: 1, name: 'Sunil', gender: 'Male' },
    { id: 2, name: 'Supriya', gender: 'Female' },
    { id: 3, name: 'Pradeep', gender: 'Male' },
    { id: 4, name: 'Bhaurao', gender: 'Male' },
    { id: 5, name: 'Vivek', gender: 'Male' },
    { id: 6, name: 'Zakir', gender: 'Male' },
    { id: 7, name: 'Minakshi', gender: 'Female' },
    { id: 8, name: 'Shraddha', gender: 'Female' },
    { id: 9, name: 'Niranjan', gender: 'Male' },
    { id: 10, name: 'Khajamin', gender: 'Male' },
    { id: 11, name: 'Urmila', gender: 'Female' },
    { id: 12, name: 'Veena', gender: 'Female' },
    { id: 13, name: 'Ajay', gender: 'Male' },
    { id: 14, name: 'Javed', gender: 'Male' },
    { id: 15, name: 'Manohar', gender: 'Male' },
];
...
module.exports = __webpack_require__(/*! /home/sunil/more_work/angular_sample_app/src/main.ts */"./src/main.ts");
